    ...
    <div className="about-parent">
      ...
      <div className="about-container">
        ...
        <div className="about-text-container">
          <h3 className="about-text-heading">What HNN is about ?</h3> <hr />
          <p className="about-text">
            The Health and Nutrition Network (HNN), aims to eradicate hunger and enhance health in our communities. Our mission is to empower local communities by providing access to nutritious food, essential health services, and wellness education. We collaborate with NGOs and local organizations to ensure every community member thrives. Our platform includes donation portals, resource mapping, virtual workshops, telemedicine services, and community forums. Join us in creating sustainable solutions for hunger and health, driving positive social impact, and building healthier, hunger-free communities. <span>Together, we can make a difference.</span>
          </p>
        </div>
      </div>
      <div>
